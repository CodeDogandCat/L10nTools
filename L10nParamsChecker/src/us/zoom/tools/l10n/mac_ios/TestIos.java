...
public class TestIos {
	...
	public static void main(String[] args) {
		...
		commandMap.put(Command.DEFAULT_LANGUAGE_RESOURCE_FILE, "test/ios/Localizable-en.strings");
		commandMap.put(Command.COMPARED_LANGUAGE_RESOURCE_FILE, "test/ios/Localizable-cn.strings");
		commandMap.put(Command.OUT_FILE, "test/ios/ios_checker.txt");
